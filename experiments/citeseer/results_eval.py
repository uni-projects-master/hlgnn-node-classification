...
def run_validation(forceobj=True):
    ...
    test_name = 'run_1_LGCN-fully-supervised_data-citeseer_dropout-0.5_weight-decay-0.0_num_layer-6_hidden-dim-32_backtrack-True_activationReLU_update-MAX_inc-in'
    ...
    plots.vis_embeddings(model_out, labels, dataset_name)
