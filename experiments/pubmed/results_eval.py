...
def run_validation(forceobj=True):
    ...
    test_name = 'run_2_LGCN-fully-supervised_data-pubmed_dropout-0.2_weight-decay-0.0_num_layer-8_hidden-dim-32_backtrack-False_activationReLU_update-SUM_inc-both'
